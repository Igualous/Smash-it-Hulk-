...
ANIMA_CIMA:
       ...
       la a0,hulk_pulando_cima #carrega as dimensoes do hulk em a0
       la s6,HULK_POS #posicao atual do hulk
       lw a2,0(s6)  #carrega em a2 a posicao vertical do hulk
       lw t6,0(s6) #temporario para verificar se a animacao ja chegou ao fim
       addi t6,t6,-60  # acumula em t0 a ultima posicao do hulk
      
        
 ANIMA_CONT2:
 
 addi a2,a2,-1 #move uma linha da animacao
 jal renderImage # renderiza a imagem na proxima posicao      
 bgt a2,t6,ANIMA_CONT2 #se ainda nao chegou na ultima posicao, continua
...
ANIMA_ESQ:
       ...
       la a0,hulk_pulando_e #carrega as dimensoes do hulk em a0
       la s6,HULK_POS #posicao atual do hulk
       lw a1,0(s6)  #carrega em a1 a posicao horizontal do hulk
       lw t6,0(s6) #temporario para verificar se a animacao ja chegou ao fim
       addi t6,t6,-50  # acumula em t0 a ultima posicao do hulk
      
        
 ANIMA_CONT1:
 
 addi a1,a1,-1 #move uma coluna da animacao
 jal renderImage # renderiza a imagem na proxima posicao      
 bgt a1,t6,ANIMA_CONT1 #se ainda nao chegou na ultima posicao, continua
...
CHAR_BAIXO:
       ...
       la a0,hulk_pulando_baixo #carrega as dimensoes do hulk em a0
       la s6,HULK_POS #posicao atual do hulk
       lw a2,0(s6)  #carrega em a1 a posicao horizontal do hulk
       lw t6,0(s6) #temporario para verificar se a animacao ja chegou ao fim
       addi t6,t6,60  # acumula em t0 a ultima posicao do hulk
 ...
 addi a2,a2,1 #move uma coluna da animacao
 jal renderImage # renderiza a imagem na proxima posicao      
 bgt a2,t6,ANIMA_CONT3 #se ainda nao chegou na ultima posicao, continua
...
ANIMA_DIR:
       ...
       la a0,hulk_pulando_d #carrega as dimensoes do hulk em a0
       la s6,HULK_POS #posicao atual do hulk
       lw a1,0(s6)  #carrega em a1 a posicao horizontal do hulk
       lw t6,0(s6) #temporario para verificar se a animacao ja chegou ao fim
       addi t6,t6,50  # acumula em t0 a ultima posicao do hulk
 ...
 addi a1,a1,1 #move uma coluna da animacao
 jal renderImage # renderiza a imagem na proxima posicao      
 blt a1,t6,ANIMA_CONT #se ainda nao chegou na ultima posicao, continua    
